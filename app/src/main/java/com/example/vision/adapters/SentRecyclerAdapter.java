...
import com.example.vision.models.MessageModel;
import com.example.vision.utils.DoubleClick;
import com.example.vision.utils.DoubleClickListener;

import java.util.ArrayList;

public class SentRecyclerAdapter extends RecyclerView.Adapter {

    Context context;
    ArrayList<MessageModel> items;
    private OnPositionListener onPositionListener;

    public SentRecyclerAdapter(OnPositionListener onPositionListener, ArrayList<MessageModel> contacts, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        final View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_sent_layout, viewGroup, false);
